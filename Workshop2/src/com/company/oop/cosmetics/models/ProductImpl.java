...
public abstract class ProductImpl implements Product {
    ...
    private static final String NAME_INVALID_MESSAGE = "Name should be between 2 and 10 symbols.";
    ...
    {
        ValidationHelpers.validateStringLength(brand,BRAND_MIN_LENGTH,BRAND_MAX_LENGTH,BRAND_INVALID_MESSAGE);
        this.brand = brand;
    }
    ...
    protected void setPrice(double price)
    {
        if(price<0)
        {
            throw new IllegalArgumentException("Price should non be negative");
        }
        else {
            this.price = price;
        }
